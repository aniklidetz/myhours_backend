...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=2025,
            help='Year for work logs. Default: 2025'
        )
        parser.add_argument(
            '--employees',
            type=str,
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR('Invalid months format. Use comma-separated numbers (e.g., 5,6)'))
            return
        ...
        for month in months:
            ...
            month_shifts = self._add_sabbath_shifts(employees, year, month, shifts_per_month)
    ...
    def _create_sabbath_shift(self, employee, friday):
        ...
        try:
            ...
            sabbath_times = EnhancedSunriseSunsetService.get_shabbat_times_israeli_timezone(friday)
            ...
            shift_patterns = [
                ...
                {
                    'start_offset': timedelta(hours=-2, minutes=30),  # Before Sabbath end
            ...
            self.stdout.write(
                self.style.ERROR(f'   ❌ Error creating Sabbath shift for {employee.get_full_name()}: {e}')
            )
            return False
