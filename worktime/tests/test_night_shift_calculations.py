...
class NightShiftCalculationTest(TestCase):
    ...
    def test_partial_night_shift_evening(self):
        ...
        self.assertEqual(result.night_hours, 4)
        # Total 6h shift with 4h night - all 6h are regular (under 7h limit)
        self.assertEqual(result.regular_hours, 6)
    def test_partial_night_shift_morning(self):
        ...
        self.assertEqual(result.night_hours, 2)
    ...
    def test_sabbath_night_shift(self):
        ...
        self.assertGreater(result.sabbath_night_hours, 0)
        self.assertGreater(
            result.sabbath_night_pay, result.night_pay
        )
    ...
    def test_max_16_hour_shift(self):
        ...
        self.assertEqual(result.night_hours, 0)
        # Day shift: max 8.6h regular per shift, rest is overtime
        self.assertEqual(result.regular_hours, Decimal("8.6"))
        self.assertEqual(
            result.overtime_hours, Decimal("7.40")
