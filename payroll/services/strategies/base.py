...
class AbstractPayrollStrategy(ABC):
    ...
    def _get_salary_info(self, employee):
        ...
        try:
            ...
            if salary is None:
                raise AttributeError(f"No active salary configuration for employee {self._employee_id}")
    ...
    def _log_performance_metrics(
        ...
        self.logger.info(f"{self._strategy_name} {operation} performance", extra=metrics)