...
class PayrollCalculatorFactory:
    ...
    def __init__(self):
        ...
        self._fallback_strategy: CalculationStrategy = CalculationStrategy.get_fallback()
...
def register_default_strategies() -> None:
    ...
    try:
        ...
        logger.warning(
            ...
            extra={
                "error": str(e),
                "action": "strategy_import_warning"
            }
        )
...
def create_calculator_for_context(
    context: CalculationContext,
    preferred_strategy: CalculationStrategy = None
) -> AbstractPayrollStrategy:
    """
    ...
    if preferred_strategy and factory.is_strategy_available(preferred_strategy):
        ...
        if not factory.is_strategy_available(strategy_type):
            ...
            if available:
                ...
                raise StrategyNotFoundError("No payroll calculation strategies are registered")
