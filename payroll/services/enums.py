...
class CalculationStrategy(Enum):
    ...
    """Critical points algorithm for precise payroll calculation"""
    ...
    def display_name(self) -> str:
        ...
        return {
            ...
            self.CRITICAL_POINTS: "Critical Points Algorithm",
    ...
    def description(self) -> str:
        ...
        return {
            ...
            self.CRITICAL_POINTS: "Precise calculation using critical points algorithm",
