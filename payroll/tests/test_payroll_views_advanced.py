...
class PayrollListAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_payroll_list_with_monthly_summary_cache(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        response = self.client.get(f'/api/v1/payroll/?year={current_date.year}&month={current_date.month}')
...
class EnhancedEarningsAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_enhanced_earnings_employee_specific(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        response = self.client.get(f'/api/v1/payroll/earnings/?employee_id={self.employee.id}')
    ...
    def test_enhanced_earnings_invalid_date_params(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        response = self.client.get('/api/v1/payroll/earnings/?year=abc&month=xyz&day=invalid')
    ...
    def test_enhanced_earnings_service_error(self):
        ...
        self.assertIn(response.status_code, [status.HTTP_200_OK, status.HTTP_500_INTERNAL_SERVER_ERROR, status.HTTP_404_NOT_FOUND])
...
class DailyPayrollCalculationsAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_daily_calculations_with_date_filter(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        today = date.today()
        response = self.client.get(f'/api/v1/payroll/daily-calculations/?date={today.isoformat()}')
    ...
    def test_daily_calculations_with_employee_filter(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        response = self.client.get(f'/api/v1/payroll/daily-calculations/?employee_id={self.employee.id}')
...
class PayrollAnalyticsAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_analytics_admin_with_filters(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        today = date.today()
        response = self.client.get(f'/api/v1/payroll/analytics/?year={today.year}&month={today.month}')
    ...
    def test_analytics_accountant_access(self):
        ...
        accountant_employee = Employee.objects.create(
            ...
            first_name="Account", last_name="Manager",
            email="accountant@test.com",
            employment_type="full_time", role="accountant"
        )
...
class MonthlyPayrollSummaryAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_monthly_summary_employee_filter(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        response = self.client.get(f'/api/v1/payroll/monthly-summary/?employee_id={self.employee.id}')
...
class PayrollHelperFunctionsAdvancedTest(PayrollViewsAdvancedTest):
    ...
    def test_legacy_payroll_calculation(self):
        ...
        try:
            result = _legacy_payroll_calculation(employees, current_date, start_date, end_date)
