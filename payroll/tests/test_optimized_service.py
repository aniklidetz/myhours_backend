...
class OptimizedPayrollServiceTest(TestCase):
    ...
    def setUp(self):
        ...
        self.employee1 = Employee.objects.create(
            user=self.user1,
            first_name="Test", last_name="Employee1",
            email="emp1@test.com",
        ...
        self.employee2 = Employee.objects.create(
            user=self.user2,
            first_name="Test", last_name="Employee2",
            email="emp2@test.com",
...
class OptimizedServiceBulkCalculationTest(OptimizedPayrollServiceTest):
    ...
    def test_calculate_bulk_payroll_empty_employees(self, mock_cache):
        ...
        results = service.calculate_bulk_payroll(employees, self.test_year, self.test_month)
    ...
    def test_calculate_bulk_payroll_cache_failure(self, mock_cache):
        ...
        mock_cache.get_holidays_with_shabbat_times.side_effect = Exception("Cache error")
...
class OptimizedServiceEdgeCasesTest(OptimizedPayrollServiceTest):
    ...
    def test_statistics_accuracy(self, mock_cache):
        ...
        self.assertGreaterEqual(api_usage2["calculations_performed"], api_usage1["calculations_performed"])
        self.assertGreaterEqual(api_usage2["cache_hits"] + api_usage2["cache_misses"], 
