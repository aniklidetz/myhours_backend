...
class SalarySerializerFieldValidationTest(SalarySerializerTest):
    ...
    def test_validate_base_salary_valid(self):
        ...
        # Test valid salaries
        self.assertEqual(serializer.validate_base_salary(Decimal('5300')), Decimal('5300'))  # Minimum wage
        self.assertEqual(serializer.validate_base_salary(Decimal('10000')), Decimal('10000'))  # Above minimum
        self.assertEqual(serializer.validate_base_salary(Decimal('0')), Decimal('0'))  # Zero is valid
    ...
    def test_validate_hourly_rate_valid(self):
        ...
        # Test valid rates
        self.assertEqual(serializer.validate_hourly_rate(Decimal('28.49')), Decimal('28.49'))  # Minimum
        self.assertEqual(serializer.validate_hourly_rate(Decimal('50.00')), Decimal('50.00'))  # Above minimum
        self.assertEqual(serializer.validate_hourly_rate(Decimal('0')), Decimal('0'))  # Zero is valid
    ...
    def test_validate_calculation_type_project_disabled(self):
        ...
        error_message = str(cm.exception)
        self.assertIn("Project payroll calculation is currently disabled", error_message)
    ...
    def test_validate_calculation_type_project_not_configured(self):
        ...
        self.assertIn("Project payroll calculation is currently disabled", str(cm.exception))
...
class SalarySerializerCrossFieldValidationTest(SalarySerializerTest):
    ...
    def test_validate_project_end_before_start(self):
        ...
        self.assertIn("Project end date must be after start date", str(error_dict['project_end_date']))
    ...
    def test_validate_project_disabled_in_validate_method(self):
        ...
        self.assertIn("Project payroll calculation is currently disabled", str(error_dict['calculation_type']))
...
class CompensatoryDaySerializerIntegrationTest(CompensatoryDaySerializerTest):
    ...
    def test_serializer_with_date_used(self):
        ...
        data = {
            ...
            'reason': 'holiday',
            'date_used': (date.today() - timedelta(days=1)).isoformat()  # Used yesterday
        }
    ...
    def test_serializer_with_future_date_used(self):
        ...
        self.assertIn("Used date cannot be in the future", str(serializer.errors['date_used']))
