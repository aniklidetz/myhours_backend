...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--month", type=str, help="Month in YYYY-MM format or number (1-12)")
    ...
    def handle(self, *args, **options):
        ...
        for calc in calculations:
            ...
            components = [
                ...
                "bonus_sabbath_pay", "bonus_holiday_pay", "bonus_night_pay_1", 
                "bonus_night_pay_2", "base_pay",
            ]
            new_total = sum((getattr(calc, f, None) or Decimal("0")) for f in components)
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Successfully updated {updated_count} payroll calculations")
        )