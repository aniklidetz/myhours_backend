...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write("Recalculating daily payroll for monthly employees with fixed overtime logic...")
        ...
        self.stdout.write(f"Found {calculations.count()} daily calculations with overtime for monthly employees")
                ...
                if abs(new_total_pay - old_total_pay) > Decimal('0.01'):
                    if not options['dry_run']:
                        ...
                        if 'breakdown' in result:
                            ...
                            calc.overtime_pay_1 = breakdown.get('overtime_pay_1', Decimal('0'))
                            calc.overtime_pay_2 = breakdown.get('overtime_pay_2', Decimal('0'))
        ...
        if options['dry_run']:
            ...
            self.stdout.write(
                self.style.SUCCESS(f'Successfully recalculated {updated_count} daily calculations, {errors} errors')
            )