...
from .views import (
    ...
    daily_payroll_calculations, monthly_payroll_summary, 
    recalculate_payroll, payroll_analytics
)
...
urlpatterns = [
    ...
    path('daily-calculations/', daily_payroll_calculations, name='daily-payroll-calculations'),
