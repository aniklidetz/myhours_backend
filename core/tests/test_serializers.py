...
class CoreSerializersModuleTest(TestCase):
    ...
    def test_all_exports_available(self):
        ...
        expected_exports = ['EmployeeSerializer', 'WorkLogSerializer', 'SalarySerializer']
    ...
    def test_all_exports_importable(self):
        ...
        for export_name in __all__:
            self.assertTrue(hasattr(core.serializers, export_name),
    ...
    def test_serializer_inheritance_check(self):
        ...
        for serializer_class in [EmployeeSerializer, WorkLogSerializer, SalarySerializer]:
    ...
    def test_module_import_structure(self):
        ...
        expected_attributes = ['EmployeeSerializer', 'WorkLogSerializer', 'SalarySerializer', '__all__']
        
        for attr in expected_attributes:
            self.assertTrue(hasattr(core_serializers, attr),
    ...
    def test_serializer_class_attributes(self):
        ...
        for serializer_class in serializer_classes:
            ...
            expected_modules = ['users.serializers', 'worktime.serializers', 'payroll.serializers']
    ...
    def test_namespace_pollution_prevention(self):
        ...
        public_attrs = [attr for attr in module_attrs 
                       if not attr.startswith('_') and attr != '__all__']
        
        expected_public_attrs = ['EmployeeSerializer', 'WorkLogSerializer', 'SalarySerializer']
        
        # Should only have the expected public attributes
        self.assertEqual(set(public_attrs), set(expected_public_attrs),
