                ...
                if not cache.get(sync_key):
                    ...
                    for year in [current_year, current_year + 1]:
                        try:
                            ...
                            logger.info(f"Auto-synced holidays for {year}: {created} created, {updated} updated")
                    ...
                    logger.info("Holiday synchronization completed, next sync in 7 days")
                else:
                    logger.debug("Holiday synchronization skipped - already synced within 7 days")
