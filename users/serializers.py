...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    def get_has_biometric(self, obj):
        ...
        try:
            ...
            if (
                ...
                and "biometric_profile" in obj._prefetched_objects_cache
            ):
    ...
    def get_hourly_rate(self, obj):
        ...
        try:
            ...
            if (
                hasattr(obj, "_prefetched_objects_cache")
                and "salary_info" in obj._prefetched_objects_cache
            ):
                salary_info = getattr(obj, "salary_info", None)
                return (
                    float(salary_info.hourly_rate)
                    if salary_info and salary_info.hourly_rate
                    else None
                )
            # Fallback to property
            if hasattr(obj, "salary_info") and obj.salary_info:
                return (
                    float(obj.salary_info.hourly_rate)
                    if obj.salary_info.hourly_rate
                    else None
                )
            return None
        except:
    ...
    def get_monthly_salary(self, obj):
        ...
        try:
            ...
            if (
                ...
                salary_info = getattr(obj, "salary_info", None)
                return (
                    float(salary_info.base_salary)
                    if salary_info and salary_info.base_salary
                    else None
                )
            # Fallback to property
            if hasattr(obj, "salary_info") and obj.salary_info:
                return (
                    float(obj.salary_info.base_salary)
                    if obj.salary_info.base_salary
                    else None
                )
            return None
        except:
    ...
    def get_has_pending_invitation(self, obj):
        ...
        try:
            ...
            if (
                hasattr(obj, "_prefetched_objects_cache")
                and "invitation" in obj._prefetched_objects_cache
            ):
...
class EmployeeUpdateSerializer(serializers.ModelSerializer):
    ...
    phone_number = serializers.CharField(
        source="phone", required=False, allow_blank=True
    )
