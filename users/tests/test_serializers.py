...
class EmployeeSerializerTest(TestCase):
    ...
    def test_read_only_fields(self):
        ...
        expected_read_only_fields = [
            'id', 'created_at', 'updated_at', 'is_registered', 'has_biometric'
        ]
...
class EmployeeInvitationSerializerTest(TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        # Create users
        self.user = User.objects.create_user(username='employee', email='employee@example.com')
    ...
    def test_serialization_all_fields(self):
        ...
        expected_fields = [
            'id', 'employee', 'employee_name', 'employee_email', 'token',
            'invited_by', 'invited_by_name', 'created_at', 'expires_at',
            'accepted_at', 'email_sent', 'email_sent_at', 'is_valid',
    ...
    def test_read_only_fields(self):
        ...
        expected_read_only_fields = [
            'id', 'token', 'created_at', 'expires_at', 'accepted_at',
...
class SendInvitationSerializerTest(TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        self.user = User.objects.create_user(username='employee', email='employee@example.com')
        self.registered_user = User.objects.create_user(username='registered', email='reg@example.com')
...
class AcceptInvitationSerializerTest(TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        self.admin_user = User.objects.create_user(username='admin', email='admin@example.com')
        self.existing_user = User.objects.create_user(username='existing', email='existing@example.com')
