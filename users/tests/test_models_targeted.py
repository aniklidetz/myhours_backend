...
class EmployeeModelTest(TestCase):
    ...
    def test_is_valid_phone_method_valid_numbers(self):
        ...
        for phone in valid_phones:
            self.assertTrue(employee._is_valid_phone(phone), f"Phone {phone} should be valid")
    ...
    def test_is_valid_phone_method_invalid_numbers(self):
        ...
        for phone in invalid_phones:
            self.assertFalse(employee._is_valid_phone(phone), f"Phone {phone} should be invalid")
    ...
    def test_get_full_name_method(self):
        ...
        # Test with spaces
        employee = Employee(first_name=' John ', last_name=' Doe ')
        self.assertEqual(employee.get_full_name(), 'John   Doe')  # strip() only removes leading/trailing
...
class EmployeeInvitationTest(TestCase):
    ...
    def test_create_invitation_classmethod(self):
        ...
        self.assertEqual(len(invitation.token), 43)  # token_urlsafe(32) produces ~43 chars
    ...
    def test_employee_roles_and_permissions_integration(self):
        ...
        for role, expected_staff, expected_superuser in roles_permissions:
            with self.subTest(role=role):
                ...
                self.assertEqual(user.is_superuser, expected_superuser,
