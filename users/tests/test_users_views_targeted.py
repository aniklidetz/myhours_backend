...
class EmployeeViewSetCreateTest(APITestCase):
    ...
    @patch('payroll.models.Salary.objects.create')
    def test_perform_create_success(self, mock_salary_create, mock_safe_log, mock_logger):
...
class EmployeeViewSetActionTest(APITestCase):
    ...
    def test_activate_success(self, mock_logger):
        ...
        response = self.client.post(f'/api/v1/users/employees/{self.target_employee.id}/activate/')
    ...
    def test_deactivate_success(self, mock_logger):
        ...
        response = self.client.post(f'/api/v1/users/employees/{self.target_employee.id}/deactivate/')
