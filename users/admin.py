...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'email', 'employment_type', 
                   'is_active', 'is_registered', 'has_invitation')
...
class EmployeeInvitationAdmin(admin.ModelAdmin):
    list_display = ('employee_email', 'status', 'invited_by', 'created_at', 
                   'expires_at', 'email_sent')
