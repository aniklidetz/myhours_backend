...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="tokenrefreshlog",
            index=models.Index(
                fields=["-refreshed_at"], name="users_token_refresh_idx"
            ),
        ),
        # BiometricSession indexes
        migrations.AddIndex(
            model_name="biometricsession",
            index=models.Index(fields=["device_token"], name="bio_sess_device_idx"),
        ),
        migrations.AddIndex(
            model_name="biometricsession",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="biometricsession",
            index=models.Index(fields=["expires_at"], name="bio_sess_expires_idx"),
        ),
        migrations.AddIndex(
            model_name="biometricsession",
            index=models.Index(fields=["-started_at"], name="bio_sess_started_idx"),
        ),
        ...
        migrations.AddIndex(
            model_name="employee",
            index=models.Index(
                fields=["-created_at"], name="users_employee_created_idx"
            ),
        ),
    ]
